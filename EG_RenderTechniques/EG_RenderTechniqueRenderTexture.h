...
class EG_RenderTechniqueRenderTexture : public EG_RenderTechnique
{
    public:
        GLuint m_textureUnitUniformLocation;
        GLuint m_pixelSizeUniformLocation;
        EG_RenderTechniqueRenderTexture();
        ~EG_RenderTechniqueRenderTexture();
        ...
        void render(unsigned int TextureId, GLuint FboTarget, int Width, int Height);
};
