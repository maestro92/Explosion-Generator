...
{                                                                                           
    vec3 LightDirection = outWorldPos - gPointLights[Index].position;                         
    ...
    vec4 Color = CalcLightInternal(gPointLights[Index].base, LightDirection, outWorldPos, Normal);       
...
void main()
{
    ...
    vec4 DirColor = vec4(outColor, 1.0) * CalcDirectionalLight(outWorldPos, normal); 
