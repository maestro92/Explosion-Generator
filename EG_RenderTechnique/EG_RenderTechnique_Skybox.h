#ifndef EG_RENDER_TECHINQUE_SKYBOX_H_
#define EG_RENDER_TECHINQUE_SKYBOX_H_
...
class EG_RenderTechnique_Skybox : public EG_RenderTechnique
{
    private:
