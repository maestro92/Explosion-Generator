...
class EG_SkyBox : public EG_RenderTechnique
{
  ...
  //      void RenderSkyBox_Dynamic(shader* skybox_shader, pipeline& m_pipeline);
        void render1(pipeline &m_pipeline, EG_RenderTechnique* RenderTechnique, int RenderPassID);
        void renderStatic(pipeline &m_pipeline, EG_RenderTechnique* RenderTechnique, int RenderPassID);
