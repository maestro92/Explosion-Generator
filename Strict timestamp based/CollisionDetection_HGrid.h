...
class CollisionDetection_HGrid : public CollisionDetection_Interface
{
   ...
   //     void CheckObjAgainstObjects(h_Particle * h_par, vector<h_Particle*>& neighbors);
        bool CheckObjAgainstObjects(h_Particle * h_par, vector<h_Particle*>& neighbors);
        ...
        bool CheckSphereGroundCollision(h_Particle * h_par, float dt);
        bool CheckSphereSphereCollision(h_Particle * h_par1, h_Particle * h_par2);


        void HandleSphereSphereCollision(h_Particle * h_par1, h_Particle * h_par2);
};
