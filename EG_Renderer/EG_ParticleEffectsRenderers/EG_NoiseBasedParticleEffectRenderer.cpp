...
*/
    ...
    initDataPairUniLoc(&m_depthPair2,           m_shaders[RENDER_PASS2], RENDER_PASS2, "u_depth");
    initDataPairUniLoc(&m_inverseSizePair2,     m_shaders[RENDER_PASS2], RENDER_PASS2, "u_inverseSize");
    ...
    Varyings[0] = "v_position";
    Varyings[1] = "v_birthTime";
    ...
    initDataPairUniLoc(&m_timePair3,            m_shaders[RENDER_PASS3], RENDER_PASS3, "u_time");
    initDataPairUniLoc(&m_sizeDataPair,         m_shaders[RENDER_PASS3], RENDER_PASS3, "Size");
    initDataPairUniLoc(&m_extentDataPair,       m_shaders[RENDER_PASS3], RENDER_PASS3, "Extent");
