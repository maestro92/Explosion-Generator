...
CubeEmitterEffect::CubeEmitterEffect()
{
...
void CubeEmitterEffect::InitParticleCube()
{
...
void CubeEmitterEffect::InitParticlePos(int i, int k, int j, int Index)
{
...
void CubeEmitterEffect::InitParticleVel(int i, int k, int j, int Index)
{
//    float vel_x, vel_y, vel_z;
...
void CubeEmitterEffect::InitParticleAttribute(int i, int k, int j, int Index)
{
    float lifetime;
...
void CubeEmitterEffect::Reset()
{
    InitParticleCube();
}

void CubeEmitterEffect::UpdateParticleCube(float dt)
{
    for(int i = 0; i < e_ParticleBuffer.size(); i++)
    {
...
void CubeEmitterEffect::DrawParticleCube()
{
    for(int i = 0; i < e_ParticleBuffer.size(); i++)
    {
...
void CubeEmitterEffect::update(bool toggle)
{
    UpdateParticleCube(0.031);
}

void CubeEmitterEffect::show(bool toggle)
{
    DrawParticleCube();
}
